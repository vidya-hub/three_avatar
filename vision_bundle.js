...
function N(t) {
  ...
  var e = t.g;
  return null ==
    (e = null == e || R(e) ? e : "string" == typeof e ? F(e) : null)
    ? e
    : (t.g = e);
}
var U = class {
...
function V(t) {
  ...
  if (t.constructor === ArrayBuffer)
    return { buffer: new Uint8Array(t), N: !1 };
  ...
  if (16 > t.length) Y(Number(t));
    ...
    for (let r = e, s = ((n - e) % 6) + e; s <= n; r = s, s += 6) {
      ...
      (K *= 1e6),
        (z = 1e6 * z + e),
        4294967296 <= z &&
          ((K += Math.trunc(z / 4294967296)), (K >>>= 0), (z >>>= 0));
    }
    if (e) {
      const [t, e] = nt(z, K);
      (z = t), (K = e);
...
function rt(t, e) {
  ...
  for (32 < i && (s |= (127 & n) >> 4), i = 3; 32 > i && 128 & n; i += 7)
    (n = o[a++]), (s |= (127 & n) << i);
...
function yt(t, e, n) {
  ...
  let o = i - r;
  if (
    (0 >= o && ((t.g.l = i), n(e, t, void 0, void 0, void 0), (o = i - t.g.g)),
    o)
  )
    throw Error(
...
function we(t) {
  return (
    (t = Math.trunc(t)), Number.isSafeInteger(t) || (Y(t), (t = J(z, K))), t
  );
}
function Te(t) {
...
var je = class extends Ue {
  constructor(t, e, n = Be, r = Be) {
    ...
    for (let i = 0; i < t.length; i++) {
      const o = t[i],
        a = n(o[0], !1, !0);
      let h = o[1];
      e ? void 0 === h && (h = null) : (h = r(o[1], !1, !0, void 0, void 0, s)),
        super.set(a, h);
    }
  }
  oa(t = Xe) {
  ...
  get(t) {
    ...
    if (void 0 !== e) {
      var n = this.U;
      return n
        ? ((n = this.Z(e, !1, !0, n, this.ta, this.L)) !== e && super.set(t, n),
          n)
        : e;
    }
  }
  ...
  if (null != t) {
    ...
    return (
      t.X === te
        ...
        : t instanceof je &&
          !(2 & t.L) &&
          ((n = $t(t.Y(Je))), (t = new je(n, t.U, t.S, t.Z))),
      t
    );
  }
}
...
function cn(t, e, n) {
  ...
  var o = zt(i);
  if (!(4 & o)) {
    (4 & o || Object.isFrozen(i)) &&
      ((i = Bt(i)), (o = Sn(o, r, !1)), (r = sn(t, r, e, i)));
    var a = 0;
    let s = 0;
    for (; a < i.length; a++) {
      const t = n(i[a]);
  ...
  return (
    dn(o) ||
      ((n = o),
      (o = (a = 1 === s) ? Wt(o, 2, !0) : Wt(o, 32, !1)) !== n && Yt(i, o),
      a && Object.freeze(i)),
    2 === s &&
      dn(o) &&
      ((i = Bt(i)), (o = Sn(o, r, !1)), Yt(i, o), sn(t, r, e, i)),
    i
  );
}
function un(t, e, n) {
...
function pn(t, e, n) {
  {
    ...
    if ((ae(a), null == n)) sn(o, a, e);
      ...
      if (((r = !i) && (r = !1), !(4 & t)))
        for (
          t = 21, i && ((n = Bt(n)), (s = 0), (t = Sn(t, a, !0))), i = 0;
          i < n.length;
          i++
        )
          n[i] = be(n[i]);
      r && ((n = Bt(n)), (s = 0), (t = Sn(t, a, !0))),
        t !== s && Yt(n, t),
        sn(o, a, e, n);
    }
  }
...
function En(t, e, n, r) {
  ...
  let o;
  if (null != i && i.X === te)
    return (e = tn(i)) !== i && sn(t, s, n, e, r), e.u;
  if (Array.isArray(i)) {
    const t = zt(i);
...
function An(t, e, n, r, s, i) {
  ...
  if (((n = !!(8 & c) || (h && !o.length)), i && !n)) {
    for (
      dn(c) && ((o = Bt(o)), (c = Sn(c, e, s)), (e = sn(t, e, r, o))),
        i = o,
        n = c,
        l = 0;
      l < i.length;
  ...
  return (
    dn(c) ||
      ((i = c),
      h
        ? (c = Wt(c, !o.length || (16 & c && (!u || 32 & c)) ? 2 : 2048, !0))
        : s || (c = Wt(c, 32, !1)),
      c !== i && Yt(o, c),
      h && Object.freeze(o)),
...
function xn(t, e, n, r) {
  ...
  let s = Kt(t);
  ae(s),
    (n = vn(t, s, n)) && n !== e && null != r && (s = sn(t, s, n)),
    sn(t, s, e, r);
}
function Sn(t, e, n) {
  return (
    (t = Wt(t, 2, !!(2 & e))), (t = Wt(t, 32, !!(32 & e) && n)), Wt(t, 2048, !1)
  );
}
function Ln(t, e, n, r) {
  t = t.u;
      ...
      : (t, e) => {
          for (; gt(e) && 4 != e.h; ) {
            ...
            (i && i(e, t, s)) ||
              ...
              i.ia
                ? (i = void 0)
                : ((o = i.g.g - s), (i.g.g = s), (i = ft(i.g, o))),
              (s = t),
              i &&
                ((ce ||= Symbol()), (o = s[ce]) ? o.push(i) : (s[ce] = [i])));
          }
...
function Zn(t, e, n, r, s = Jn) {
  ...
  for (h = 1; void 0 !== o; ) {
    ...
    for (
      u = h + 1,
        "number" == typeof (o = t[++i]) && 0 > o && ((u -= o), (o = t[++i]));
      h < u;
      h++
    ) {
      const t = a[h];
...
function lr(t, e, n) {
  ...
  if (256 & r) {
    ...
    for (let t in r)
      (s = +t),
        Number.isNaN(s) || (null != (i = r[t]) && (a = ur(n, s)) && a(e, i, s));
  }
  if ((t = ce ? t[ce] : void 0))
    for (Pt(e, e.g.end()), n = 0; n < t.length; n++) Pt(e, N(t[n]) || P());
}
function dr(t, e) {
...
function Tr(t, e, n) {
  null !=
    (e =
      null == e || "string" == typeof e || R(e) || e instanceof U
        ? e
        : void 0) && Dt(t, n, V(e).buffer);
}
function Ar(t, e, n) {
  return (
    (5 === t.h || 2 === t.h) &&
    ((e = on(e, Kt(e), n, 2, !1)),
    2 == t.h ? Et(t, ht, e) : e.push(ht(t.g)),
    !0)
  );
}
var br,
...
br = new Ut(
  ...
  function (t, e, n, r, s) {
    if (Array.isArray(e))
      for (let i = 0; i < e.length; i++) wr(t, e[i], n, r, s);
  },
  !0,
  !0
);
...
cs[336783863] = [
  ...
  -1,
  Pr,
  [0, [1, 2, 3, 4, 5], Vr, os, Vr, rs, Vr, ss, Vr, as, Vr, ts],
  Qr,
];
var ls = [0, Ur, Dr],
...
function Ao(t, e) {
  return (
    ...
    void 0 !== t.maxResults
      ? Cn(e, 2, t.maxResults)
      : "maxResults" in t && rn(e, 2),
    void 0 !== t.scoreThreshold
      ? In(e, 3, t.scoreThreshold)
      : "scoreThreshold" in t && rn(e, 3),
    void 0 !== t.categoryAllowlist
      ? pn(e, 4, t.categoryAllowlist)
      : "categoryAllowlist" in t && rn(e, 4),
    void 0 !== t.categoryDenylist
      ? pn(e, 5, t.categoryDenylist)
      : "categoryDenylist" in t && rn(e, 5),
    e
  );
}
function bo(t, e = -1, n = "") {
...
async function Xo(t, e, n, r) {
  return (
    (t = await (async (t, e, n, r, s) => {
      if ((e && (await Do(e)), !self.ModuleFactory))
        throw Error("ModuleFactory not set.");
      if (n && (await Do(n), !self.ModuleFactory))
        throw Error("ModuleFactory not set.");
      return (
        self.Module &&
          s &&
          ...
          s.mainScriptUrlOrBlob &&
            (e.mainScriptUrlOrBlob = s.mainScriptUrlOrBlob)),
...
function Ho(t, e) {
  ...
  "string" == typeof e
    ? (rn(n, 2, ke(e)), rn(n, 1))
    : e instanceof Uint8Array && (rn(n, 1, se(e, !1, !1)), rn(n, 2)),
...
function na(t, e, n, r) {
  return (
    ...
    t.h || (t.m(), t.D()),
    n
      ? (t.s || (t.s = ta(t, !0)), (n = t.s))
      : (t.v || (t.v = ta(t, !1)), (n = t.v)),
    e.useProgram(t.h),
    n.bind(),
    t.l(),
    (t = r()),
...
var oa = class {
  ...
  m() {
    ...
    (this.P = t.getAttribLocation(this.h, "aVertex")),
      (this.O = t.getAttribLocation(this.h, "aTex"));
  }
  D() {}
  l() {}
  close() {
...
function la(t) {
  ...
  if (!e) {
    ...
    const r = ua(t),
      s = fa(t);
    n.texImage2D(n.TEXTURE_2D, 0, s, t.width, t.height, 0, n.RED, n.FLOAT, r),
      ma(t);
  }
  return e;
}
...
function ga(t) {
  ...
  return (
    n ||
      ((n = ra(pa(t), e, t.m ? e.LINEAR : e.NEAREST)), t.g.push(n), (t.j = !0)),
...
function xa(t, e, n) {
  if (e.R()) n(e.M());
    ...
    t.m = t.m ?? new oa();
    const s = ka(t);
    n((t = new _a([r], e.m, !1, s.canvas, t.m, e.width, e.height)).M()),
      t.close();
  }
}
function Sa(t, e, n, r) {
...
function Ia(t) {
  ...
  let n = Ra(t, 2);
  return (
    n || ((n = ra(Ca(t), e)), t.g.push(n), (t.m = !0)),
    e.bindTexture(e.TEXTURE_2D, n),
    n
  );
}
      ...
      Uo(this, n, (n) => {
        Uo(this, e, (e) => {
          ...
          this.i.HEAPU8.set(t, s),
            this.i._addProtoToInputStream(s, t.length, e, n, r),
            this.i._free(s);
        });
      });
    }
...
function Wa(t, e, n, r) {
  if (t.V) {
    ...
    if (n?.rotationDegrees) {
      ...
      if (
        (In(i, 5, (-Math.PI * n.rotationDegrees) / 180),
...
var $a = class extends qo {
  ...
  l(t, e = !0) {
    if (
      ("runningMode" in t &&
        On(this.baseOptions, 2, !!t.runningMode && "IMAGE" !== t.runningMode),
  ...
  o(t) {
    return (
      "minDetectionConfidence" in t &&
        In(this.h, 2, t.minDetectionConfidence ?? 0.5),
      "minSuppressionThreshold" in t &&
        In(this.h, 3, t.minSuppressionThreshold ?? 0.3),
      this.l(t)
    );
  }
  F(t, e) {
  ...
  o(t) {
    return (
      ...
      "minFaceDetectionConfidence" in t &&
        In(this.s, 2, t.minFaceDetectionConfidence ?? 0.5),
      "minTrackingConfidence" in t &&
        In(this.h, 4, t.minTrackingConfidence ?? 0.5),
      "minFacePresenceConfidence" in t &&
        In(this.v, 2, t.minFacePresenceConfidence ?? 0.5),
      ...
      this.outputFaceBlendshapes &&
        ...
        this.g.attachProtoVectorListener("blendshapes", (t, e) => {
          if (this.outputFaceBlendshapes)
            for (const e of t)
              (t = Ds(e)), this.j.faceBlendshapes.push(bo(t.g() ?? []));
          zo(this, e);
        }),
...
var ch = class extends $a {
  constructor(t, e) {
    super(new Xa(t, e), "image_in", "norm_rect", !0),
      kn((t = this.j = new Ui()), 0, 1, (e = new bi()));
  }
  get baseOptions() {
  ...
  Pa(t, e, n) {
    ...
    if (
      ((this.h = "function" == typeof e ? e : n), za(this, t, r ?? {}), !this.h)
    )
      return this.s;
  }
  m() {
      ...
      this.g.W("stylized_image", (t, e) => {
        ...
        if (r instanceof Uint8Array)
          if (r.length === 3 * i) {
            ...
            if (r.length !== 4 * i)
              throw Error("Unsupported channel count: " + r.length / i);
            r = new ImageData(
  ...
  o(t) {
    if (
      ...
      "minHandDetectionConfidence" in t &&
        In(this.v, 2, t.minHandDetectionConfidence ?? 0.5),
      "minTrackingConfidence" in t &&
        In(this.s, 4, t.minTrackingConfidence ?? 0.5),
      "minHandPresenceConfidence" in t &&
        In(this.D, 2, t.minHandPresenceConfidence ?? 0.5),
      ...
      void 0 === t.cannedGesturesClassifierOptions && Tn(this.h, Gi, 3)?.g();
    return (
      t.customGesturesClassifierOptions
        ? (kn(
            ...
            0,
            2,
            (r = Ao(t.customGesturesClassifierOptions, Tn(this.h, Gi, 4)?.h()))
          ),
          kn(this.h, 0, 4, e))
...
var mh = class extends $a {
  ...
  o(t) {
    return (
      ...
      "minHandDetectionConfidence" in t &&
        In(this.j, 2, t.minHandDetectionConfidence ?? 0.5),
      "minTrackingConfidence" in t &&
        In(this.h, 4, t.minTrackingConfidence ?? 0.5),
      "minHandPresenceConfidence" in t &&
        In(this.s, 2, t.minHandPresenceConfidence ?? 0.5),
      this.l(t)
    );
  }
  F(t, e) {
  ...
  o(t) {
    return (
      ...
      "minFaceSuppressionThreshold" in t &&
        In(this.s, 3, t.minFaceSuppressionThreshold ?? 0.3),
      "minFacePresenceConfidence" in t &&
        In(this.P, 2, t.minFacePresenceConfidence ?? 0.5),
      "outputFaceBlendshapes" in t &&
        (this.outputFaceBlendshapes = !!t.outputFaceBlendshapes),
      "minPoseDetectionConfidence" in t &&
        In(this.v, 2, t.minPoseDetectionConfidence ?? 0.5),
      "minPoseSuppressionThreshold" in t &&
        In(this.v, 3, t.minPoseSuppressionThreshold ?? 0.3),
      "minPosePresenceConfidence" in t &&
        In(this.J, 2, t.minPosePresenceConfidence ?? 0.5),
      ...
      "minHandLandmarksConfidence" in t &&
        In(this.I, 2, t.minHandLandmarksConfidence ?? 0.5),
      this.l(t)
    );
  }
  F(t, e, n) {
    ...
    ms(r, "mediapipe.tasks.vision.holistic_landmarker.HolisticLandmarkerGraph"),
      ...
      this.outputPoseSegmentationMasks &&
        ...
        this.g.W("pose_segmentation_mask", (t, e) => {
          (this.h.poseSegmentationMasks = [Ya(this, t, !0, !this.D)]),
            zo(this, e);
        }),
      ...
      this.outputFaceBlendshapes &&
        ...
        this.g.attachProtoListener("extra_blendshapes", (t, e) => {
          ...
          this.outputFaceBlendshapes && ((t = Ds(t)), n.push(bo(t.g() ?? []))),
            zo(this, e);
        }),
  ...
  o(t) {
    ...
    return (
      ...
      void 0 !== t.l2Normalize
        ? On(n, 1, t.l2Normalize)
        : "l2Normalize" in t && rn(n, 1),
      void 0 !== t.quantize
        ? On(n, 2, t.quantize)
        : "quantize" in t && rn(n, 2),
      kn(e, 0, 2, n),
      this.l(t)
    );
  }
...
(Ah.cosineSimilarity = function (t, e) {
  if (t.floatEmbedding && e.floatEmbedding)
    t = Fo(t.floatEmbedding, e.floatEmbedding);
  else {
  ...
  o(t) {
    return (
      void 0 !== t.displayNamesLocale
        ...
        : "displayNamesLocale" in t && rn(this.h, 2),
      void 0 !== t.maxResults
        ? Cn(this.h, 3, t.maxResults)
        : "maxResults" in t && rn(this.h, 3),
      void 0 !== t.scoreThreshold
        ? In(this.h, 4, t.scoreThreshold)
        : "scoreThreshold" in t && rn(this.h, 4),
      void 0 !== t.categoryAllowlist
...
var Qh = class extends $a {
  ...
  o(t) {
    return (
      ...
      "minPoseDetectionConfidence" in t &&
        In(this.j, 2, t.minPoseDetectionConfidence ?? 0.5),
      "minTrackingConfidence" in t &&
        In(this.h, 4, t.minTrackingConfidence ?? 0.5),
      "minPosePresenceConfidence" in t &&
        In(this.v, 2, t.minPosePresenceConfidence ?? 0.5),
    ...
    ms(n, "mediapipe.tasks.vision.pose_landmarker.PoseLandmarkerGraph"),
      ...
      this.outputSegmentationMasks &&
        ...
        this.g.da("segmentation_masks", (t, e) => {
          (this.segmentationMasks = t.map((t) => Ya(this, t, !0, !this.s))),
            zo(this, e);
        }),
